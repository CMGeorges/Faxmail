   ...
   protected boolean type=false;
    ...
    private void btnAddDecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddDecActionPerformed
       //jFDeclaration.setSize(762, 680);
                    ...
                    txtDeclarant.setEnabled(true);
                    txtNomPatient.setEnabled(true);
                    jDateBirthDe.setEnabled(true);//change for jdate
                    txtDeTel.setEnabled(true);
                    txtDeAdresse.setEnabled(true);
                    txtNumASsM.setEnabled(true);
                    txtDrDemandeur.setEnabled(true);
                    txtNomDemande.setEnabled(true);
                    txtPermis.setEnabled(true);
                    txtMilieuConsult.setEnabled(true);
                    txtAdresseDr.setEnabled(true);
                    txtSitePre.setEnabled(true);
                    jCBStatus.setEnabled(true);
                    JDatePre.setEnabled(true);
                    jDateExe.setEnabled(true);
                    txtTypePre.setEnabled(true);
                    txtAnalyse.setEnabled(true);
                    txtResultat.setEnabled(true);
                    btnSaveDec.setEnabled(true);
                    
                    txtDeclarant.setText(null);
                    txtNomPatient.setText(null);
                    jDateBirthDe.setDate(null);//change for jdate
                    txtDeTel.setText(null);
                    txtDeAdresse.setText(null);
                    txtNumASsM.setText(null);
                    txtDrDemandeur.setText(null);;
                    txtNomDemande.setText(null);;
                    txtPermis.setText(null);
                    txtMilieuConsult.setText(null);
                    txtAdresseDr.setText(null);
                    txtSitePre.setText(null);                    
                    JDatePre.setDate(null);
                    jDateExe.setDate(null);
                    txtTypePre.setText(null);
                    txtAnalyse.setText(null);
    ...
    private void btnEnregistrerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnregistrerActionPerformed
        ...
        try {
            ...
            if (type) { //Vérification du type d'utilisateur
                ...
                folderUse.getPatient().setEmail(txtDCourriel.getText());
                updateFolder();
...
//        System.out.println("Test getCalendar().getTime()"+ birthDate);
    ...
    /**
     * 
     * En cas ou la taille du Folder est trop gros et le téléchargement prend du temps.
     */
    ...
    /**
     * Set les données dans leur aera respectif.
     * @param f : Folder
     */
...
try {
            folds.stream().filter((f) -> (f.getNumDossier() == folderUse.getNumDossier())).map((f) -> {
                f.setPatient(folderUse.getPatient());
                //System.out.println(folderUse.getPatient().getEmail());
                return f;
            }).map((_item) -> {
                folds.add(folderUse);
                return _item;
 ...
 */
    ...
    /**
     * Update de de la BD par l'enqueteur
     * @param e1
